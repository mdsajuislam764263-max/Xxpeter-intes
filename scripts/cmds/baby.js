...
module.exports = {
  config: {
    name: "baby",
    aliases: ["màry", "àxé", "hippi", "maria", "axe", "bbz"],
    version: "3.6",
  ...
  onStart: async function ({ api, event, args, message, usersData }) {
    ...
    try {
      ...
      if (!query) {
        ...
        const ran = ["𝒉𝒖𝒖 𝒋𝒂𝒏 𝒃𝒐𝒍𝒐😒", "𝒂𝒄𝒉𝒊 𝒕𝒐 𝒌𝒂𝒏𝒂🙄", "𝒃𝒂𝒔𝒕𝒐 𝒂𝒄𝒉𝒊 𝒌𝒉𝒂𝒓-𝒄𝒉𝒐𝒐𝒓😒🙄", "𝒂𝒔𝒔𝒂𝒍𝒂𝒎𝒖𝒍𝒂𝒊𝒌𝒖𝒎 𝒌𝒊𝒄𝒉𝒖 𝒃𝒐𝒍𝒃𝒂 💟"];
...
${formatted}`
      ...
      let responses = Array.isArray(res.data.response) ? res.data.response : [res.data.response
