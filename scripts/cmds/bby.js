...
module.exports.onStart = async ({
    ...
    try {
        if (!args[0]) {
            const ran = ["𝒉𝒖𝒖 𝒋𝒂𝒏 𝒃𝒐𝒍𝒐😥", "𝒂𝒕𝒐 𝒅𝒂𝒌𝒐 𝒌𝒂𝒏😒", "𝒊𝒎 𝒃𝒖𝒔𝒚 𝒌𝒉𝒂𝒓-𝒄𝒉𝒐𝒐𝒓😒🙄", "𝒉𝒖𝒖 𝒋𝒂𝒏 𝒃𝒐𝒍𝒐 😒"];
...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("𝒉𝒊𝒏𝒂𝒕𝒂") || body.startsWith("𝒕𝒖𝒎𝒊 𝒌𝒐𝒊") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            const arr = body.replace(/^\S+\s*/, "")
            const randomReplies = ["😚", "𝒂𝒊 𝒂𝒄𝒉𝒊 𝒂𝒎𝒊 😒, 𝒌𝒊 𝒌𝒐𝒔", "𝒃𝒐𝒍𝒐 𝒃𝒃𝒚 𝒂𝒄𝒉𝒊 𝒕𝒐😏"];
            if (!arr) {
